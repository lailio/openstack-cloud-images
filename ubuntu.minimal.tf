...
resource "openstack_images_image_v2" "ubuntu-16.04-minimal-cloudimg-amd64-uefi1" {
  name             = "ubuntu-16.04-minimal-amd64"
  image_source_url = "https://cloud-images.ubuntu.com/daily/server/minimal/releases/xenial/release/ubuntu-16.04-minimal-cloudimg-amd64-uefi1.img"
  container_format = "bare"
  disk_format      = "qcow2"
  web_download     = true
  protected        = true
...
resource "openstack_images_image_v2" "ubuntu-18.10-minimal-cloudimg-amd64" {
...
resource "openstack_images_image_v2" "ubuntu-19.04-minimal-cloudimg-amd64" {
...
resource "openstack_images_image_v2" "ubuntu-19.10-minimal-cloudimg-amd64" {
...
resource "openstack_images_image_v2" "ubuntu-20.04-minimal-cloudimg-amd64" {
...
resource "openstack_images_image_v2" "ubuntu-20.04-minimal-cloudimg-amd64" {
  name             = "ubuntu-20.04-minimal-amd64"
  image_source_url = "https://cloud-images.ubuntu.com/daily/server/minimal/releases/groovy/release/ubuntu-20.10-minimal-cloudimg-amd64.img"
  container_format = "bare"
  disk_format      = "qcow2"
  web_download     = true
  protected        = true
...
resource "openstack_images_image_v2" "ubuntu-21.04-minimal-cloudimg-amd64" {
...
resource "openstack_images_image_v2" "ubuntu-21.10-minimal-cloudimg-amd64" {
...
resource "openstack_images_image_v2" "ubuntu-22.04-minimal-cloudimg-amd64" {
...
resource "openstack_images_image_v2" "ubuntu-22.10-minimal-cloudimg-amd64" {
...
resource "openstack_images_image_v2" "ubuntu-23.04-minimal-cloudimg-amd64" {
...
resource "openstack_images_image_v2" "ubuntu-23.10-minimal-cloudimg-amd64" {
...
resource "openstack_images_image_v2" "ubuntu-23.10-minimal-cloudimg-arm64" {
...
resource "openstack_images_image_v2" "ubuntu-24.04-minimal-cloudimg-amd64" {
...
resource "openstack_images_image_v2" "ubuntu-24.04-minimal-cloudimg-arm64" {
...
resource "openstack_images_image_v2" "ubuntu-24.10-minimal-cloudimg-amd64" {
...
resource "openstack_images_image_v2" "ubuntu-24.10-minimal-cloudimg-arm64" {
